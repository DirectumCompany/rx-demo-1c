...
using Sungero.Integration1CDemo.OutgoingInvoice;
...
namespace Sungero.Integration1CDemo.Client
{
  partial class OutgoingInvoiceActions
  {
    ...
    {
      var getHyperlinkResult = Sungero.Integration1CDemo.PublicFunctions.Module.Remote.GetSyncEntity1CHyperlink(_obj, Constants.Module.OutgoingInvoiceExtEntityType);
