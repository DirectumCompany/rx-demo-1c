...
namespace Sungero.Demo1C.Server
{
  partial class IncomingInvoiceFunctions
  {
    ...
    public Sungero.ExternalSystem.Structures.Module.ISupplierInvoiceDto ConvertTo1cDto()
    {
      ...
      result.Контрагент_Key = Sungero.Demo1C.PublicFunctions.ExternalEntityLink.Remote.GetForEntityIn1C(_obj.Counterparty, PublicConstants.Commons.ExternalEntityLink.typeCounterparties)?.ExtEntityId;
